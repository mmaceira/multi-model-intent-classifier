"""Unified evaluation workflow that **never** touches the models.

`run_evaluations` reads the artefacts generated by `run_training`
(predictions, probabilities) and computes all metrics and visualisations.

This separation guarantees that evaluation is completely deterministic and
reproducible – no randomness from model inference is involved.
"""
