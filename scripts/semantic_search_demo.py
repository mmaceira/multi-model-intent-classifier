...
Semantic search demo application using sentence transformers and FAISS for efficient similarity search.
"""
...
# Default paths
DEFAULT_INDEX_PATH = "output/experiment_with_03_classes/embeddings/sbert/index.faiss"
DEFAULT_META_PATH = "output/experiment_with_03_classes/embeddings/sbert/meta.jsonl"
...
def search_similar_documents(query: str, k: int = 5, index_path: str = DEFAULT_INDEX_PATH, meta_path: str = DEFAULT_META_PATH):
